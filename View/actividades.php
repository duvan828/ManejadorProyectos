<?php
    ...
    if(isset($_GET['estado'])){
        $actividades = $ctlActividad->getEstados();
    } 
    else {
        $actividades = $ctlActividad->list();
    }
    function infoPro($idProyecto, $ctlProyecto){
        $proyecto = $ctlProyecto->info($idProyecto);
        ...
        <div class="row w-100">
            ...
            <div class="col-4 mb-4">
                <div class="card card-form w-100">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Información de actividad</h5>
                        <form class="form" action="../index.php?controller=actividad&action=update&id=<?php echo $idActividad?>" method="post">
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" id="idProyecto" name="idActividad" placeholder="idActividad"  <?php echo 'value="'.$idActividad.'"'  ?> required disabled>
                            ...
                            <div class="form-floating mb-2">
                                <select class="form-select" id="idProyecto" name="idProyecto" aria-label="Proyecto" >
                                    <option>Seleccionar</option>
                                    <?php
                                    foreach ($proyectos as $value) {
                                        if ($value['idProyecto']==$idProyecto){
                                            echo '<option value="'.$value['idProyecto'].'" selected>'.$value['descripcion'].'</option>';
                                        }
                                        else {
                                            echo '<option value="'.$value['idProyecto'].'">'.$value['descripcion'].'</option>';
                                        }
                                    }
                                    ?>
                                </select>
            ...
            <div class="col-4 mb-4">
                ...
                <div class="card card-form w-100">
                    <h5 class="card-header">Registro Actividad</h5>
                    <div class="card-body">
                        <h5 class="card-title">Información de actividad</h5>
                        <form class="form" action="../index.php?controller=actividad&action=insert" method="post">
                        <div class="form-floating mb-2">
                            ...
                            <div class="form-floating mb-2">
                                ...
                                <label for="responsable">Proyecto</label>
                            </div>
                            <div class="form-floating mb-2">
                                <select class="form-select" id="responsable" name="responsable" aria-label="Responsable" >
                                    <option>Seleccionar</option>
            ...
            <div class="col-8 mb-4" >
                <a href="actividades.php" class="btn btn-primary mx-2">TODOS</a>
                <a href="actividades.php?estado=terminado" class="btn btn-success mx-2">TERMINADOS</a>
                <a href="actividades.php?estado=comenzado" class="btn btn-warning mx-2">COMENZANDOS</a>
                <a href="actividades.php?estado=sin iniciar" class="btn btn-dark mx-2">SIN INICIAR</a>
                <a href="actividades.php?estado=Atrasado" class="btn btn-danger mx-2">ATRASADO</a>
                            ...
                            <tbody>
                                <?php
                                    foreach ($actividades as $value) {
                                        ...
                                        echo '<tr>
                                            <th scope="row">'.$value['idActividad'].'</th>
                                            <td>'.$value['descripcion'].'</td>
                                            <td>'.$value['fecha_inicio'].'</td>
                                            <td>'.$value['fecha_fin'].'</td>
                                            <td>'.infoPro($value['idProyecto'], $ctlProyecto).'</td>
                                            <td>'.info($value['responsable'], $ctlPersona).'</td>
                                            <td>'.$estado.'</td>
                                            <td>'.$value['presupuesto'].'</td>
                                            <td>
                                            <a class="btn btn-primary" href="../index.php?controller=actividad&action=listId&id='.$value['idActividad'].'">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                                    <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z"/>
                                                </svg>
                                            </a>    
                                            <a class="btn btn-danger" href="../index.php?controller=actividad&action=delete&id='.$value['idActividad'].'">

...
<body>
    <form class="modal-content animate" action="../index.php?controller=persona&action=login" method="post">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="idPersona" id="idPersona" type="number" placeholder="Documento" />
